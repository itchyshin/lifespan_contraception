...
bind_rows(
dat_m_horm[ , c(1,18:28)], # 1
dat_m_surg[ , c(1,18:28)], # 2
dat_f_horm[ , c(1,18:28)], # 3 
dat_f_surg[ , c(1,18:28)], # 4
) -> dat_all
...
# we want to get species which has both Female and Male

dat_m_surg %>% group_by(Species) %>% # count male and female per spp
