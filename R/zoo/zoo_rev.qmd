...
```{r}
# main data
dat0 <- read_csv(here("data", "zoo", "zoo_rev.csv"), na = c("", "NA"))
...
bind_rows(
dat_m_horm[ , c(1,18:29)], # 1
dat_m_surg[ , c(1,18:29)], # 2
dat_f_horm[ , c(1,18:29)], # 3 
dat_f_surg[ , c(1,18:29)], # 4
) -> dat_all
