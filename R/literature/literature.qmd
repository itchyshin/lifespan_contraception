...
lnrre <- function(m1, m2, n1, n2) {
  ...
  lnrr2 <- log(log(ea1)/log(ea2))
  
  # teh delta method again
  var2 <- V1*(1/ea1)^2 + V2*(1/ea2)^2
  
  invisible(data.frame(yi = lnrr , vi = var, yj = lnrr2, vj = var2))
}
...
dat$v2 <- ifelse(effect_type == "longevity", lnrrm(dat$Treatment_lifespan_variable, dat$Control_lifespan_variable, dat$Sample_size_sterilization, dat$Sample_size_control, cvs[["cv2_trt"]],cvs[["cv2_cont"]])[[2]], lnrre(dat$Treatment_lifespan_variable, dat$Control_lifespan_variable, dat$Sample_size_sterilization, dat$Sample_size_control)[[2]])
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github Local/lifespan_contraception/figs/literature/fig1a.png)
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github Local/lifespan_contraception/figs/literature/fig2.png)
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github Local/lifespan_contraception/figs/literature/fig4A.png)
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github Local/lifespan_contraception/figs/literature/fig4B.png)
:::
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github Local/lifespan_contraception/figs/literature/fig5.png)
:::
