---
title: "Code for literature data for **Female contraception and male castration increase lifespan across vertebrates**"
subtitle: "**Supplmentary Information 2**"
...
# save results
saveRDS(results, here("Rdata", "fig", "results.rds"))

# create a new cluster
dat$Phylo_Sex <- paste(dat$Phylogeny, dat$Sex , sep = "_" )

# rho = 0.5 is as in Noble et al (Mol Ecol)
# the same as vi and vi2 are the same
dat <- escalc(yi=yi, vi=vi2, data = dat)
...
# saving ddat as rds
saveRDS(ddat, here("Rdata", "fig", "ddat.rds"))


# start here
#### CODE

resutls <- readRDS(here("Rdata", "fig", "results.rds"))
ddat <- readRDS(here("Rdata", "fig", "ddat.rds"))
...
phy_sex <- ggplot(data = ddat, aes(x = yi, y = Species_Latin)) +
  ...
  geom_vline(xintercept = results$estimate, linetype = 1, colour = "red", alpha = 0.3) +
 xlim(-1.6, 1.6) +
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github%20Local/lifespan_contraception/figs/literature/fig1a.png)
:::
...
# orchard plot
p2 <- dat_m_surgard_plot(mod_rem, mod = "Sex_Gonads", 
                   xlab = "log response ratio (lnRR)", 
                   group = "Study", cb = F,
                   angle = 0) 
...
## Figure: forest and orchard plots
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github%20Local/lifespan_contraception/figs/literature/fig1.png)

## Figure: orchard and bubble plots
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github%20Local/lifespan_contraception/figs/literature/fig2.png)
:::
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github%20Local/lifespan_contraception/figs/literature/fig4A.png)
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github%20Local/lifespan_contraception/figs/literature/fig4B.png)
:::
...
![](/Users/z3437171/Library/CloudStorage/Dropbox/Github%20Local/lifespan_contraception/figs/literature/fig5.png)
:::
