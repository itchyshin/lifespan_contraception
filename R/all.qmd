...
mod_not_all1b <- rma.mv(yi, V = VCV2,
                   mod = ~ sex - 1,
                   random = list(
                     ~1|species,
                     ~1|phylogeny,
                   ...
                   test = "t",
                   sparse = TRUE)
summary(mod_not_all1b)

round(r2_ml(mod_not_all1b), 5)

orchard_plot(mod_not_all1b, mod = "sex",
             xlab = "lnRR (all)", group = "species", g = FALSE)
```
