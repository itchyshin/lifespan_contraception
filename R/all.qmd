...
## Different types of sex differences: absolute values
...
res_sex_ab$data <- res_sex_ab$data %>% filter(moderator == "Female sterlized/\nMale normal"| moderator ==  "Female normal/\nMale normal") 
