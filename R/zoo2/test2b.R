...
dat_trauma <- escalc(measure = "RD", 
                     ai = Contra_Trauma_Low*Contra_Total_N, 
                     bi = (1-Contra_Trauma_Low)*Contra_Total_N, 
                     ci = noContra_Trauma_Low*noContra_Total_N,
                     di = (1-noContra_Trauma_Low)*noContra_Total_N,
                     var.names = c("yi_trauma_low", "vi_trauma_low"),
                     data = dat)
# Med

dat_trauma <- escalc(measure = "RD", 
                     ai = Contra_Trauma_Med*Contra_Total_N, 
                     bi = (1-Contra_Trauma_Med)*Contra_Total_N, 
                     ci = noContra_Trauma_Med*noContra_Total_N,
                     di = (1-noContra_Trauma_Med)*noContra_Total_N,
...
dat_trauma <- escalc(measure = "RD", 
                     ai = Contra_Trauma_Upp*Contra_Total_N, 
                     bi = (1-Contra_Trauma_Upp)*Contra_Total_N, 
                     ci = noContra_Trauma_Upp*noContra_Total_N,
                     di = (1-noContra_Trauma_Upp)*noContra_Total_N,
...
p_trauma <- orchard_plot(mod_trauma_reg, mod = "type",
                         xlab = "log risk ratio (Trauma)", group = "Species") + ylim(-0.85, 0.7)
...
dat_infectious <- escalc(measure = "RD", 
                         ai = Contra_InfectDisease_Low*Contra_Total_N,
                         bi = (1-Contra_InfectDisease_Low)*Contra_Total_N,
                         ci = noContra_InfectDisease_Low*noContra_Total_N,
                         di = (1-noContra_InfectDisease_Low)*noContra_Total_N,
...
dat_infectious <- escalc(measure = "RD",
                         ai = Contra_InfectDisease_Med*Contra_Total_N, 
                         bi = (1-Contra_InfectDisease_Med)*Contra_Total_N, 
                         ci = noContra_InfectDisease_Med*noContra_Total_N,
                         di = (1-noContra_InfectDisease_Med)*noContra_Total_N,
...
dat_infectious <- escalc(measure = "RD",
                         ai = Contra_InfectDisease_Upp*Contra_Total_N, 
                         bi = (1-Contra_InfectDisease_Upp)*Contra_Total_N, 
                         ci = noContra_InfectDisease_Upp*noContra_Total_N,
                         di = (1-noContra_InfectDisease_Upp)*noContra_Total_N,
...
#dat_long_infectious %>% filter(Sex_Type != "Male_Hormonal") -> dat_long_infectious2

# VCV2

# VCV2 <- vcalc(dat_long_infectious2$vi, 
#               cluster = dat_long_infectious2$Effect_ID, 
#               obs = dat_long_infectious2$Effect_ID2, 
#               data = dat_long_infectious2, rho = 0.5)
...
dat_noninfectious <- escalc(measure = "RD", 
                            ai = Contra_NonInfectDisease_Low*Contra_Total_N,
                            bi = (1-Contra_NonInfectDisease_Low)*Contra_Total_N,
                            ci = noContra_NonInfectDisease_Low*noContra_Total_N,
                            di = (1-noContra_NonInfectDisease_Low)*noContra_Total_N,
...
dat_noninfectious <- escalc(measure = "RD",
                            ai = Contra_NonInfectDisease_Med*Contra_Total_N, 
                            bi = (1-Contra_NonInfectDisease_Med)*Contra_Total_N, 
                            ci = noContra_NonInfectDisease_Med*noContra_Total_N,
                            di = (1-noContra_NonInfectDisease_Med)*noContra_Total_N,
...
dat_noninfectious <- escalc(measure = "RD",
                            ai = Contra_NonInfectDisease_Upp*Contra_Total_N, 
                            bi = (1-Contra_NonInfectDisease_Upp)*Contra_Total_N, 
                            ci = noContra_NonInfectDisease_Upp*noContra_Total_N,
                            di = (1-noContra_NonInfectDisease_Upp)*noContra_Total_N,
...
dat_chronic <- escalc(measure = "RD", 
                      ai = Contra_ChronDisease_Low*Contra_Total_N,
                      bi = (1-Contra_ChronDisease_Low)*Contra_Total_N,
                      ci = noContra_ChronDisease_Low*noContra_Total_N,
                      di = (1-noContra_ChronDisease_Low)*noContra_Total_N,
...
dat_chronic <- escalc(measure = "RD",
                      ai = Contra_ChronDisease_Med*Contra_Total_N, 
                      bi = (1-Contra_ChronDisease_Med)*Contra_Total_N, 
                      ci = noContra_ChronDisease_Med*noContra_Total_N,
                      di = (1-noContra_ChronDisease_Med)*noContra_Total_N,
...
dat_chronic <- escalc(measure = "RD",
                      ai = Contra_ChronDisease_Upp*Contra_Total_N, 
                      bi = (1-Contra_ChronDisease_Upp)*Contra_Total_N, 
                      ci = noContra_ChronDisease_Upp*noContra_Total_N,
                      di = (1-noContra_ChronDisease_Upp)*noContra_Total_N,
...
dat_deathAtBirth <- escalc(measure = "RD", 
                           ai = Contra_deathAtBirth_Low*Contra_Total_N,
                           bi = (1-Contra_deathAtBirth_Low)*Contra_Total_N,
                           ci = noContra_deathAtBirth_Low*noContra_Total_N,
                           di = (1-noContra_deathAtBirth_Low)*noContra_Total_N,
...
dat_deathAtBirth <- escalc(measure = "RD",
                           ai = Contra_deathAtBirth_Med*Contra_Total_N, 
                           bi = (1-Contra_deathAtBirth_Med)*Contra_Total_N, 
                           ci = noContra_deathAtBirth_Med*noContra_Total_N,
                           di = (1-noContra_deathAtBirth_Med)*noContra_Total_N,
...
dat_deathAtBirth <- escalc(measure = "RD",
                           ai = Contra_deathAtBirth_Upp*Contra_Total_N, 
                           bi = (1-Contra_deathAtBirth_Upp)*Contra_Total_N, 
                           ci = noContra_deathAtBirth_Upp*noContra_Total_N,
                           di = (1-noContra_deathAtBirth_Upp)*noContra_Total_N,
...
dat_other <- escalc(measure = "RD", 
                    ai = Contra_Other_Low*Contra_Total_N,
                    bi = (1-Contra_Other_Low)*Contra_Total_N,
                    ci = noContra_Other_Low*noContra_Total_N,
                    di = (1-noContra_Other_Low)*noContra_Total_N,
...
dat_other <- escalc(measure = "RD",
                    ai = Contra_Other_Med*Contra_Total_N, 
                    bi = (1-Contra_Other_Med)*Contra_Total_N, 
                    ci = noContra_Other_Med*noContra_Total_N,
                    di = (1-noContra_Other_Med)*noContra_Total_N,
...
dat_other <- escalc(measure = "RD",
                    ai = Contra_Other_Upp*Contra_Total_N, 
                    bi = (1-Contra_Other_Upp)*Contra_Total_N, 
                    ci = noContra_Other_Upp*noContra_Total_N,
                    di = (1-noContra_Other_Upp)*noContra_Total_N,
...
#dat_long_other2 <- dat_long_other %>% filter(Sex_Type != "Male_Hormonal")
